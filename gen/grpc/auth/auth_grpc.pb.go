...
func (c *authClient) GetDataFromAccessToken(ctx context.Context, in *GetDataFromAccessTokenRequest, opts ...grpc.CallOption) (*GetDataFromAccessTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, Auth_GetDataFromAccessToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Auth_GetDataFromAccessToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(AuthServer).GetDataFromAccessToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_GetDataFromAccessToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).GetDataFromAccessToken(ctx, req.(*GetDataFromAccessTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
